...
import YoutubeVideo from './components/reactYoutubeVideo/YoutubeVideo';
...
function App() {
  return (
    <BrowserRouter>
      <Routes>
        <Route path='/' element={<HomePage videosData={videosData} />} />
        <Route path='/videos/:id' element={<Videoplayer videosData={videosData} />} />
        <Route path='/youtube' element={<ReactYoutube />} />
